...
declare { double, double } @add(double, double, double, double) #2

declare { double, double } @multiply(double, double, double, double) #2

declare { double, double } @conv_from_polar(double noundef, double noundef) #2
...
37:                                               ; preds = %20
  ...
  %40 = mul i64 8, %39
  %41 = call noalias i8* @malloc(i64 noundef %40) #4
...
47:                                               ; preds = %43
  ...
  %50 = mul i64 16, %49
  %51 = call noalias i8* @malloc(i64 noundef %50) #4
...
164:                                              ; preds = %145
  ...
  %167 = mul i64 16, %166
  %168 = call noalias i8* @malloc(i64 noundef %167) #4
...
215:                                              ; preds = %211
  ...
  call void @free(i8* noundef %221) #4
  br label %222
...
240:                                              ; preds = %226
  ...
  call void @free(i8* noundef %242) #4
...
define dso_local %struct.complex_t* @FFT_CooleyTukey(%struct.complex_t* noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  ...
  %18 = mul i64 8, %17
  %19 = call noalias i8* @malloc(i64 noundef %18) #4
...
204:                                              ; preds = %185
  ...
  %207 = mul i64 16, %206
  %208 = call noalias i8* @malloc(i64 noundef %207) #4
